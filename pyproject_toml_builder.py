...
AUTOGENERATED_BY_COMMENT = (
    "autogenerated by 'WIPACrepo/wipac-dev-py-setup-action' github action package"
)
...
class PyProjectTomlBuilder:
    ...
    def _inline_dont_change_this_comment(section: Any) -> None:
        section.trivia.comment = (
            f" # note: no changes allowed ({AUTOGENERATED_BY_COMMENT})"
        )
