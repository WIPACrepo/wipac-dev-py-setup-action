...
DEFAULT_BASE_KEYWORDS = ["WIPAC", "IceCube"]
...
def _build_out_sections(
    ...
    # if we DO want PyPI, then include everything
        ...
        msec = MetadataSection(
            ...
            keywords=list_to_dangling(bsec.keywords_list() + DEFAULT_BASE_KEYWORDS),
            license=LICENSE,
            classifiers=list_to_dangling(
                [ffile.development_status]
                + ["License :: OSI Approved :: MIT License"]  # TODO - look @ `LICENSE`
