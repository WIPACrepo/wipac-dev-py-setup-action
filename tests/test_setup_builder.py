...
def test_50_bumping_minor_from_0_0_0(directory_0_0_0: str, requests_mock: Any) -> None:
    """Test using a minimum [wipac:cicd_setup_builder]."""
    setup_cfg_path = Path(f"{directory_0_0_0}/setup.cfg")
...
def test_51_bumping_major_from_0_0_0(directory_0_0_0: str, requests_mock: Any) -> None:
    """Test using a minimum [wipac:cicd_setup_builder]."""
    setup_cfg_path = Path(f"{directory_0_0_0}/setup.cfg")
...
def test_52_bumping_minor_from_0_0_Z(directory_0_0_Z: str, requests_mock: Any) -> None:
    """Test using a minimum [wipac:cicd_setup_builder]."""
    setup_cfg_path = Path(f"{directory_0_0_Z}/setup.cfg")
...
def test_52_bumping_major_from_0_0_Z(directory_0_0_Z: str, requests_mock: Any) -> None:
    """Test using a minimum [wipac:cicd_setup_builder]."""
    setup_cfg_path = Path(f"{directory_0_0_Z}/setup.cfg")
...
def test_53_bumping_major_from_0_Y_Z(directory_0_Y_Z: str, requests_mock: Any) -> None:
    """Test using a minimum [wipac:cicd_setup_builder]."""
    setup_cfg_path = Path(f"{directory_0_Y_Z}/setup.cfg")
