...
VANILLA_CFGOUT_OPTIONS_SECTION = """[options]  # generated by wipac:cicd_pyproject_toml_builder: python_requires, packages
install_requires =
    pyjwt
    requests
    requests-futures
...
VANILLA_SEMANTIC_RELEASE_SECTION = """[semantic_release]  # fully-generated by wipac:cicd_pyproject_toml_builder
...
VANILLA_PACKAGE_DATA_SECTION = """[options.package_data]  # generated by wipac:cicd_pyproject_toml_builder: '*'
* = py.typed"""
...
def test_00_minimum_section(directory: str, requests_mock: Any) -> None:
    ...
    pyproject_toml_in = VANILLA_CFGIN_OPTIONS_SECTIONS

    pyproject_toml_out = f"""{cicd_pyproject_toml_builder}
[metadata]  # generated by wipac:cicd_pyproject_toml_builder: name, version, url, author, author_email, description, long_description, long_description_content_type, keywords, license, classifiers, download_url, project_urls
...
[options.packages.find]  # generated by wipac:cicd_pyproject_toml_builder: include/exclude
...
def test_01_minimum_section_no_pypi(directory: str, requests_mock: Any) -> None:
    ...
    pyproject_toml_out = f"""{cicd_pyproject_toml_builder}
[metadata]  # generated by wipac:cicd_pyproject_toml_builder: name, version, author, author_email, keywords
name = mock-package
version = attr: mock_package.__version__
author = {AUTHOR}
author_email = {AUTHOR_EMAIL}
...
[semantic_release]  # fully-generated by wipac:cicd_pyproject_toml_builder
version_variable = mock_package/__init__.py:__version__
...
[metadata]  # generated by wipac:cicd_pyproject_toml_builder: name, version
name = mock-package
version = attr: mock_package.__version__
...
[options]  # generated by wipac:cicd_pyproject_toml_builder: python_requires, packages
install_requires =
    pyjwt
    requests
    requests-futures
...
def test_40_extra_fields(directory: str, requests_mock: Any) -> None:
    ...
    pyproject_toml_in = f"""{cicd_pyproject_toml_builder}
[metadata]
