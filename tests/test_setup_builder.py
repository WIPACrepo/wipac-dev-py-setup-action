...
def test_00_minimum_section(directory: str, requests_mock: Any) -> None:
    ...
    pyproject_toml_path = Path(f"{directory}/setup.cfg")
    ...
    pyproject_toml_out = f"""{cicd_setup_builder}
...
def test_02_minimum_section_no_pypi_no_keywords_no_author(
    ...
    pyproject_toml_out = f"""[wipac:cicd_setup_builder]
python_min = 3.6
...
def test_40_extra_fields(directory: str, requests_mock: Any) -> None:
    ...
    pyproject_toml_in = f"""{cicd_setup_builder}
[metadata]
...
def test_50_bumping(
    ...
    pyproject_toml_path = Path(f"{_directory(version)}/setup.cfg")
    ...
    if not patch_without_tag:
        cicd_setup_builder.update(dict(patch_without_tag="False"))
